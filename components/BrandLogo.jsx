export function BrandLogo({ className = "size-11", title = "BlackBurn Cleaning Services logo" }) {
  return (
    ...
    >
      <rect x="3" y="3" width="58" height="58" rx="8" fill="#11100d" />
      <rect x="5.5" y="5.5" width="53" height="53" rx="6" fill="none" stroke="#d8bc82" strokeWidth="1.6" />
      <path
      ...
      <path
        ...
        strokeWidth="2.2"
      />
      <path d="M13 12.5h5.5M45.5 51.5H51" stroke="#d8bc82" strokeLinecap="round" strokeWidth="1.8" />
    </svg>
  );
}
